...
<head>
    <meta charset="utf-8">
    <title>Revision Request - {{ $article->manuscript_id }}</title>
    <style>
        ...
        .letter-title { text-align: center; font-size: 18px; font-weight: bold; text-decoration: underline; margin-bottom: 25px; color: #b45309; }
...
<body>
    ...
    <div class="letter-title">MANUSCRIPT REVISION REQUEST</div>
    ...
    <div class="content">
        ...
        <p>Your manuscript <strong>"{{ $article->title }}"</strong> (ID: {{ $article->manuscript_id }}) has completed double-blind peer review.</p>
        <p>The reviewers find potential in your paper; however, publication is contingent upon addressing the requested revisions and submitting a point-by-point response letter along with your revised manuscript file.</p>
        <p>Please log into the journal editorial system or reply to the editorial office with your revised manuscript within 15 calendar days.</p>
    </div>
